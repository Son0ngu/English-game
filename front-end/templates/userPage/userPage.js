...
document.addEventListener('DOMContentLoaded', async () => {
    // 1. Lấy user hiện tại
    const resp = await fetch('http://localhost:13371/auth/HuyTranLayRoleTuID', {
        method: 'POST',
    ...
    async function loadTeacherClasses() {
        ...
        try {
            const resp = await fetch("http://localhost:13371/classroom/classes", {
                method: "POST",
                headers: {
    ...
    if (createClassBtn) {
        createClassBtn.addEventListener("click", async () => {
            ...
            try {
                const resp = await fetch("http://localhost:13371/classroom/create", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                        "Authorization": `Bearer ${token}`
    ...
    if (joinClassBtn) {
        joinClassBtn.addEventListener('click', async () => {
            ...
            const r = await fetch('http://localhost:13371/classroom/join', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${localStorage.getItem("token")}` },
    ...
    async function loadStudentClasses() {
        const r = await fetch('http://localhost:13371/classroom/student/classes', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${localStorage.getItem("token")}` },
            body: JSON.stringify({})
        });
    ...
    async function loadStudentsInClass(classId) {
        ...
        const r = await fetch('http://localhost:13371/classroom/students', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
async function kickStudent(e) {
    ...
    try {
        const res = await fetch('http://localhost:13371/classroom/kick', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem("token")}`
